...
export interface WaterOverviewData {
    stats: Stat[];
    lineChart: ChartData;
    doughnutChart: DoughnutChartData;
}
...
export interface WaterLossAnalysisData {
     distributionTotals: {
        a1: { value: string; subtitle: string; };
        a2: { value: string; subtitle: string; };
        a3: { value: string; subtitle: string; };
        a4: { value: string; subtitle: string; };
    };
    lossTotals: {
        stage1: { value: string; percentage: string; };
        stage2: { value: string; percentage: string; };
        stage3: { value: string; percentage: string; };
        total: { value: string; percentage:string; };
    };
