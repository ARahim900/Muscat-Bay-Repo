...
import type { MockData, NavItem, ViewKey, StpData, StpDailyLog, HvacData, HvacMaintenanceItem, HvacFindingPriority, ElectricityData, ElectricityRecord, BarChartData } from './types';
...
export const mockData: MockData = {
    ...
    water: {
        overview: {
            stats: [
                { id: 1, title: "Daily Consumption", value: "250 m³", change: "+2.1%", changeType: "increase" },
                { id: 2, title: "Monthly Cost", value: "OMR 4,500", change: "+4.5%", changeType: "increase" },
                { id: 3, title: "Pressure Level", value: "4.2 bar", change: "Stable", changeType: "neutral" },
                { id: 4, title: "Leaks Detected", value: "1", change: "Urgent", changeType: "increase" },
            ],
            lineChart: { labels: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"], datasets: [{ label: 'Water Consumption (m³)', data: [240, 255, 250, 260, 245, 270, 265], borderColor: '#3b82f6', backgroundColor: 'rgba(59, 130, 246, 0.1)', fill: true, tension: 0.4, }] },
            doughnutChart: { labels: ['Residential', 'Commercial', 'Landscaping'], datasets: [{ data: [60, 25, 15], backgroundColor: ['#3b82f6', '#93c5fd', '#bfdbfe'], hoverBackgroundColor: ['#2563eb', '#60a5fa', '#93c5fd'], borderColor: '#ffffff', borderWidth: 2, }] },
        },
        lossAnalysis: {
            distributionTotals: {
                a1: { value: '251,842 m³', subtitle: 'Main Bulk (NAMA)' },
                a2: { value: '244,230 m³', subtitle: 'L2 Zone Bulk + Direct' },
                a3: { value: '201,857 m³', subtitle: 'L3 Buildings + Villas' },
                a4: { value: '201,266 m³', subtitle: 'L4 Apartments + L3 End' },
            },
            lossTotals: {
                stage1: { value: '13,612 m³', percentage: '5.3%' },
                stage2: { value: '42,373 m³', percentage: '44.4%' },
                stage3: { value: '591 m³', percentage: '0.3%' },
                total: { value: '56,576 m³', percentage: '22.5%' },
            },
            consumptionTrend: { labels: ["Jan-25", "Feb-25", "Mar-25", "Apr-25", "May-25", "Jun-25", "Jul-25"], datasets: [ { label: 'L1 - Main Source', data: [450, 420, 430, 410, 440, 400, 390], borderColor: '#3b82f6', tension: 0.4 }, { label: 'L2 - Zone Bulk Meters', data: [420, 400, 410, 390, 415, 380, 370], borderColor: '#f97316', tension: 0.4 }, { label: 'L3 - Building/Villa Meters', data: [350, 340, 355, 330, 360, 320, 310], borderColor: '#10b981', tension: 0.4 }, ] },
            lossTrend: { labels: ["Jan-25", "Feb-25", "Mar-25", "Apr-25", "May-25", "Jun-25", "Jul-25"], datasets: [ { label: 'Stage 1 Loss', data: [30, 20, 20, 20, 25, 20, 20], borderColor: '#ef4444', tension: 0.4 }, { label: 'Stage 2 Loss', data: [70, 60, 55, 60, 55, 60, 60], borderColor: '#f59e0b', tension: 0.4 }, { label: 'Stage 3 Loss', data: [5, 4, 6, 5, 4, 5, 5], borderColor: '#8b5cf6', tension: 0.4 }, ] }
        },
        zoneAnalysis: { zones: ["Zone 01(A)", "Zone 02(B)", "Zone 03(A)", "Zone 04(C)"], zoneData: { "Zone 01(A)": { description: "Primarily residential villas with gardens.", consumption: "980 m³", loss: "55 m³ (5.6%)", pressure: "4.3 bar" }, "Zone 02(B)": { description: "Commercial buildings and retail outlets.", consumption: "2,100 m³", loss: "150 m³ (7.1%)", pressure: "4.0 bar" }, "Zone 03(A)": { description: "Zone with building bulk meters and individual villas.", consumption: "1,250 m³", loss: "85 m³ (6.8%)", pressure: "4.1 bar" }, "Zone 04(C)": { description: "Mixed-use with apartments and common areas.", consumption: "1,500 m³", loss: "110 m³ (7.3%)", pressure: "4.2 bar" }, } },
        consumptionType: { types: ['Commercial', 'Residential', 'Irrigation', 'Common'], consumptionData: { labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul"], datasets: [ { label: 'Commercial', data: [2000, 2100, 1900, 2200, 2300, 2150, 2400], backgroundColor: '#3b82f6' }, { label: 'Residential', data: [4500, 4600, 4400, 4700, 4800, 4650, 4900], backgroundColor: '#10b981' }, { label: 'Irrigation', data: [1500, 1550, 1450, 1600, 1650, 1580, 1700], backgroundColor: '#f97316' }, { label: 'Common', data: [500, 520, 480, 530, 550, 510, 560], backgroundColor: '#6b7280' }, ] } },
        database: { totalMeters: 352, l1Meters: 2, l2Meters: 25, l3Meters: 325, }
    },
