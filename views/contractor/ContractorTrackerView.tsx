    ...
    return (
        <div className="animate-fade-in space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {data.stats.map(stat => <StatCard key={stat.id} {...stat} layout="compact" />)}
            </div>

            <div className="bg-white p-4 rounded-2xl shadow-sm border border-slate-200/80">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-center">
                    <input type="text" placeholder="Search Contractor/Service" className="md:col-span-2 w-full p-2 border border-slate-300 rounded-lg"/>
                    <select className="w-full p-2 border border-slate-300 rounded-lg"><option>Filter by Status</option></select>
                    <button className="bg-slate-200 text-slate-700 font-semibold py-2 px-4 rounded-lg">Reset</button>
                </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200/80">
                 ...
                 <div className="flex justify-between items-center pt-4 mt-4 border-t">
                    ...
                    <div>
                         ...
                         <button className="bg-[#4E4456] text-white font-semibold py-2 px-4 rounded-lg text-sm hover:bg-opacity-90">Next</button>
                    </div>
                </div>
            </div>
