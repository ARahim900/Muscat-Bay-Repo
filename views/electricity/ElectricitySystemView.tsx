        ...
        <div className="animate-fade-in space-y-6">
            <div className="flex justify-center">
                 <div className="flex items-center gap-2 bg-slate-100 p-1 rounded-full shadow-sm border">
                    <button onClick={() => setActiveTab('overview')} className={`px-4 py-1.5 text-sm font-semibold rounded-full transition-colors ${activeTab === 'overview' ? 'bg-white shadow text-[#4E4456]' : 'text-slate-600 hover:bg-white/60'}`}>Overview</button>
                    <button onClick={() => setActiveTab('detailedLog')} className={`px-4 py-1.5 text-sm font-semibold rounded-full transition-colors ${activeTab === 'detailedLog' ? 'bg-white shadow text-[#4E4456]' : 'text-slate-600 hover:bg-white/60'}`}>Detailed Log</button>
                </div>
            </div>
