            ...
            <div className="bg-white p-4 rounded-2xl shadow-sm border border-slate-200/80">
                 <div className="flex justify-between items-center">
                    <input 
                        ...
                        className="w-full md:w-1/3 p-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-[#4E4456]/50 focus:border-[#4E4456]/50"
                        value={searchTerm}
                        onChange={e => {
                    ...
                    />
                    <button onClick={resetFilters} className="bg-slate-200 text-slate-700 font-semibold py-2 px-4 rounded-lg hover:bg-slate-300 transition-colors">Reset Filters</button>
                 </div>
            </div>
                            ...
                            {paginatedLog.map(item => (
                                <tr key={item.id} className="bg-white border-b hover:bg-slate-50">
                                    ...
                                    <td data-label="Actions" className="px-6 py-4 text-right">
                                        <button className="bg-blue-500 text-white font-bold py-1 px-3 rounded-lg text-xs hover:bg-blue-600">Edit</button>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
                 ...
                 <div className="flex justify-between items-center pt-4 mt-4 border-t">
                    ...
                    <div>
                         ...
                         <button 
                            ...
                            className="bg-[#4E4456] text-white font-semibold py-2 px-4 rounded-lg text-sm hover:bg-opacity-90 disabled:opacity-50 disabled:cursor-not-allowed">
                                Next
                        </button>
                    </div>
                </div>
