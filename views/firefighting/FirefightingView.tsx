        ...
        <div className="animate-fade-in space-y-6">
            ...
            <div className="bg-white p-4 rounded-2xl shadow-sm border border-slate-200/80">
                <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                    <input type="text" placeholder="Search Equipment..." className="md:col-span-2 w-full p-2 border border-slate-300 rounded-lg"/>
                    <select className="w-full p-2 border border-slate-300 rounded-lg"><option>All Zones</option></select>
                    <select className="w-full p-2 border border-slate-300 rounded-lg"><option>All System Types</option></select>
                    <button className="bg-[#A8D8D4] text-[#4E4456] font-semibold py-2 px-4 rounded-lg">Apply Filters</button>
                </div>
            </div>
